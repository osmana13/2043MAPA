    ...
    <div class="container">
        ...
        <form class="form-signin" action="index.php" method="post">
           <h2 class="form-signin-heading">Please sign in</h2>
            ...
            <input type="submit" class="btn btn-lg btn-primary btn-block btncolor" value="Login" /> 
            <a class="btn btn-lg btn-primary btn-block btncolor" href="register.php">Register</a>
          </form> 
